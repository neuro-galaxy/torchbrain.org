...
function Landing() {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex justify-center gap-8 mt-10 text-xl text-gray-300">
        <a
...
function InstallCommand({ command }: { command: string }) {
  ...
  return (
    <button
      onClick={handleCopy}
      title="Click to copy"
      className="flex items-center gap-4 font-mono text-sm md:text-base px-12 py-3 bg-white/5 border border-white/10 rounded-md cursor-pointer hover:bg-white/10 transition"
    >
      {command}
      <i
